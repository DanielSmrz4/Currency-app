...
# Okno
window = Tk()
window.geometry("400x120+800+400")
...
def count():
    try:
        ...
        payload = {}
        headers = {
            "apikey": "2ISZhhAral7OVUQj4Qo9dkHONowHjMr2"
        }
...
# Tlačítko přepočtu
count_button = Button(text="Přepočítat", font=("Arial", 11), command=count)
...
# Upozorňující label
notification_label = Label(bg=main_color, fg="white", font=("Arial", 11))
